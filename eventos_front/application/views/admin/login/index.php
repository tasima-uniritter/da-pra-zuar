...
<body>
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title" align="center">Painel administrativo</h3>
                    </div>
                    <div class="panel-body">
                        <form role="form" action="auth" method="post">
                            <fieldset>
                                ...
                                <input type="submit" value="Entrar" class="btn btn btn-success btn-block">
                            </fieldset>
                        </form>
                    </div>
                </div>
    ...
    <script src="<?php echo base_url(); ?>assets/sb-admin/dist/js/sb-admin-2.min.js"></script>
